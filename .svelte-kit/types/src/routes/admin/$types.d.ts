...
type LayoutRouteId = RouteId | "/admin" | "/admin/categories" | "/admin/contacts" | "/admin/content" | "/admin/journal" | "/admin/journal/new" | "/admin/journal/[postId]" | "/admin/leads" | "/admin/login" | "/admin/perks" | "/admin/perks/new" | "/admin/perks/[perkId]" | "/admin/settings" | "/admin/subcategories" | "/admin/users"
type LayoutParams = RouteParams & { postId?: string; perkId?: string }
